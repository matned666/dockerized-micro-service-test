...
class SecurityServiceTest {
    ...
    void isCollectingUsersFromRepositoryWorking(){
        ...
        assertEquals(securityService.findAll().size(), 3);
    }
    ...
    void isThrowingRuntimeExceptionWhenUserNotFound(){
        ...
        assertThrows(RuntimeException.class, ()->{
            securityService.findUserById(1L);}, USER_NOT_FOUND);
    }
    ...
    void returnedUserDTOFieldsAreTheSameAsReceivedUserFromRepository(){
        ...
        UserDTO userDTO = securityService.findUserById(1L);
    ...
    void passwordSentToDatabaseIsStillEncryptedInTheDTO(){
        ...
        securityService.add(userRegistrationDTO);
    ...
    void addingNewUserReturnsCorrectData(){
        ...
        assertEquals(securityService.add(userRegistrationDTO).getLogin(), "test3@test.tst");
    }
    ...
    void registratedPasswordIsUpdatedAndSentToDatabaseEncryptedAndDataIsEqualToTheGiven(){
        ...
        securityService.updatePassword(0L, userRegistrationDTO);
    ...
    void sentLoginThatWasChangedIsEqualToSentData(){
        ...
        securityService.updateLogin(0L, userDTO);
...
//        ASSIGNING ROLE
        securityService.assignNewRole(0L, UserRole.Role.ADMIN.name());

        assertTrue(allUsers.get(0).getRoles().contains(adminRole));
//        TAKING THE ROLE AWAY
        securityService.takeAwayRole(0L, UserRole.Role.ADMIN.name());
